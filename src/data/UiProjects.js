import casaRosa1 from "../assets/projectsUI/casaRosa1.png"
import casaRosa2 from "../assets/projectsUI/casaRosa2.png"
import massoterapia1 from "../assets/projectsUI/massoterapia1.png"
import massoterapia2 from "../assets/projectsUI/massoterapia2.png"
import map1 from "../assets/projectsUI/map1.png"
import map2 from "../assets/projectsUI/map2.png"
import vovoCarolina1 from "../assets/projectsUI/vovoCarolina1.png"
import vovoCarolina2 from "../assets/projectsUI/vovoCarolina2.png"
...
export const UiProjects = [
  {
    "img1": casaRosa1,
    "img2": casaRosa2,
    "title": "Logo - Pousada Casa Rosa",
    "links": {
      "behance": "https://www.behance.net/gallery/168299351/LOGO-POUSADA-CASA-ROSA"
    },
    "description": "Desenvolvi este logotipo para uma pousada situada na cidade de Canela-RS, onde o cliente solicitou que a fachada do local fosse representada. Para transmitir um ambiente acolhedor e não tão formal, optei por criar o desenho a mão, utilizando a mesa digitalizadora. Além disso, a paleta de cores foi inspirada em uma fotografia da própria fachada.",
    "techs": "Adobe illustrator, Mesa Digitalizadora"
  },
  {
    "img1": massoterapia1,
    "img2": massoterapia2,
    "title": "Identidade Visual - Massoteropaia Márcia Aurelia",
    "links": {
      "behance": "https://www.behance.net/gallery/105279793/IDENTIDADE-VISUAL-E-LOGO-MARCIA-AURELIA-MASSOTERAPIA"
    },
    "description": "Essa marca foi inspirada no Deus Ganesha, que é representado por um elefante. Utilizei as duas iniciais da cliente (M e A) de forma criativa, de modo que elas se encaixassem nas formas do elefante. As cores escolhidas foram baseadas na cultura hindu, para garantir a coerência com o tema da marca.",
